  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        drawerTheme: DrawerThemeData(surfaceTintColor: bgColor,backgroundColor: Colors.white, scrimColor: Colors.white),
        textTheme: GoogleFonts.poppinsTextTheme(Theme.of(context).textTheme).apply(bodyColor: textColor).copyWith(
